...
import { createUserWithEmailAndPassword, SignInUserWithEmailAndPassword, initializeSignIn,googleSignIn }  from './signInManager';
    ...
    return (
        <div className="form-signin mt-5">
            <form onSubmit={handleSubmit}>
               ...
               <img style={{width:'40px',height:'40px',marginLeft:'120px'}} onClick={handleGoogleSignIn} src={google} alt=""/>
